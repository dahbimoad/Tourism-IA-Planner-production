...
const SignupPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      // Simulate login process (replace this with your API call)
      if (email === "test@example.com" && password === "password") {
        // Save user session (example: localStorage or context)
    ...
    <section className="bg-white-100 min-h-screen flex box-border justify-center items-center">
      <div className="bg-[#ffffff] rounded-2xl flex max-w-3xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8">
          ...
          Let's discover your second country, <span className="text-red-500 font-bold">MORO</span><span className="text-green-600 font-bold">CCO.</span>
          </p>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <button
              className="bg-[#FFF1DA] text-black py-2 rounded hover:scale-105 duration-300 hover:bg-[#14183E] hover:text-[#FFF1DA] font-medium"
              type="submit"
            >
              Sign Up
            </button>
          ...
          <div className="mt-4 text-sm flex items-center">
            ...
            <button className="register py-2 px-0.5 font-semibold text-[#FF8682] font-bold" onClick={() => navigate('/login')}>
              Login
            </button>
          </div>
        </div>
