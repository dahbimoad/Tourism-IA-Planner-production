...
class EmailService:
    def __init__(self):
        ...
        self.conf = ConnectionConfig(
            ...
            MAIL_PASSWORD=settings.MAIL_PASSWORD,  # App Password
            MAIL_FROM=settings.MAIL_FROM,  # welcome@touristai.online
    ...
    async def test_email_connection(self) -> bool:
        ...
        try:
            test_message = MessageSchema(
                ...
                recipients=[settings.MAIL_USERNAME],  # Your Gmail address
